package com.dev4life.watools.speedtest
...
import com.dev4life.watools.databinding.ActivitySpeedTestBinding
import com.dev4life.watools.speedtest.test.HttpDownloadTest
import com.dev4life.watools.speedtest.test.HttpUploadTest
import com.dev4life.watools.speedtest.test.PingTest
...
//                        ivPBUpload.setAlpha(0.5f)
                    ...
                    val uploadTest = HttpUploadTest(uploadAddr)
                    while (true) {
                        if (!pingTestStarted) {
                            pingTest.start()
