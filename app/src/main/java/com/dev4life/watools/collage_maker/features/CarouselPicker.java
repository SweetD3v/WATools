package com.dev4life.watools.collage_maker.features;
...
public class CarouselPicker extends ViewPager {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setPageMargin((-getMeasuredWidth()) + SystemUtils.dpToPx(this.context, this.itemWidth));
    }
    ...
    public static class CarouselViewAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
            View inflate = LayoutInflater.from(this.context).inflate(this.drawable, null);
