...
import com.dev4life.watools.collage_maker.features.college.CollegeUtils
import com.dev4life.watools.collage_maker.features.college.PuzzleLayout
import com.dev4life.watools.collage_maker.features.college.PuzzleLayoutParser
import com.dev4life.watools.collage_maker.features.college.PuzzleView
import com.dev4life.watools.collage_maker.features.college.adapter.PuzzleAdapter
import com.dev4life.watools.collage_maker.ui.EditingToolType
import com.dev4life.watools.collage_maker.ui.EditingToolType.*
import com.dev4life.watools.collage_maker.ui.adapters.AspectRatioPreviewAdapter
import com.dev4life.watools.collage_maker.ui.adapters.BottomToolsAdapter
import com.dev4life.watools.collage_maker.ui.adapters.CollegeBGAdapter
import com.dev4life.watools.collage_maker.ui.adapters.PieceToolsAdapter
import com.dev4life.watools.collage_maker.ui.fragments.FilterDialogFragment
...
//            }
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        puzzleView.setSelectedLineColor(ContextCompat.getColor(this, R.color.color_accent))
        puzzleView.setHandleBarColor(ContextCompat.getColor(this, R.color.color_accent))
    ...
    private fun saveImage() {
        ...
        puzzleView.setTouchEnable(true)
        currentMode = NONE
        val createBitmap = createBitmap(puzzleView, 1920)
