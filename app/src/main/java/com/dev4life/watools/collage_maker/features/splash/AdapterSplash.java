package com.dev4life.watools.collage_maker.features.splash;
...
import com.dev4life.watools.collage_maker.utils.AppConstants;
import com.dev4life.watools.collage_maker.utils.SystemUtils;
import com.dev4life.watools.collage_maker.utils.UtilsAsset;
...
public class AdapterSplash extends RecyclerView.Adapter<AdapterSplash.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (this.selectedSquareIndex == i) {
            viewHolder.splash.setBorderColor(ContextCompat.getColor(context, R.color.color_accent));
