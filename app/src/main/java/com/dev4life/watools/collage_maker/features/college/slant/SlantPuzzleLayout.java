package com.dev4life.watools.collage_maker.features.college.slant;

import android.graphics.RectF;
import android.util.Pair;

import com.dev4life.watools.collage_maker.features.college.Area;
import com.dev4life.watools.collage_maker.features.college.Line;
...
public abstract class SlantPuzzleLayout implements PuzzleLayout {
    ...
    public void cutArea(int i, int i2, int i3) {
        ...
        this.lines.addAll(cutAreaWith.first);
        this.areas.addAll(cutAreaWith.second);
        updateLineLimit();
        sortAreas();
        PuzzleLayout.Step step = new PuzzleLayout.Step();
        step.type = 2;
