package com.dev4life.watools.collage_maker.features.crop.adapter;
...
public class AspectRatioPreviewAdapter extends RecyclerView.Adapter<AspectRatioPreviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        if (position == lastSelectedView) {
            ...
            viewHolder.ratioView.setColorFilter(ContextCompat.getColor(viewHolder.itemView.getContext(), R.color.color_accent_light), PorterDuff.Mode.MULTIPLY);
        } else {
