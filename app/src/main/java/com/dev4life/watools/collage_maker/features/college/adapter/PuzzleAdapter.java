package com.dev4life.watools.collage_maker.features.college.adapter;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public void onBindViewHolder(PuzzleViewHolder puzzleViewHolder, int position) {
        ...
        if (this.selectedIndex == puzzleViewHolder.getAdapterPosition()) {
            puzzleViewHolder.puzzleView.setBackgroundColor(ContextCompat.getColor(puzzleViewHolder.itemView.getContext(), R.color.color_primary));
        } else {
