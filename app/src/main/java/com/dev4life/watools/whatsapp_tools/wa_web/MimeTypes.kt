package com.dev4life.watools.whatsapp_tools.wa_web
...
class MimeTypes {
    companion object {
        ...
        const val MIME_APPLICATION_MSWORD_2007 =
            "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
        const val MIME_APPLICATION_VND_TEXT = "application/vnd.oasis.opendocument.text"
        ...
        const val MIME_APPLICATION_VND_MSEXCEL_2007 =
            "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        const val MIME_APPLICATION_VND_SPREADSHEET =
        ...
        const val MIME_APPLICATION_X_SH = "application/x-sh"
        ...
        const val MIME_APPLICATION_XML_DTD = "application/xml-dtd"
        ...
        private var mimeTypeMapping: HashMap<String, String>? = null
        private var extMapping: HashMap<String, String>? = null

        init {
            mimeTypeMapping =
                object : HashMap<String, String>(200) {
                    private fun put1(key: String, value: String) {
                        require(put(key, value) == null) { "Duplicated extension: $key" }
                    }
                    ...
                    init {
                        ...
                        put1(
                            "ods",
                            MIME_APPLICATION_VND_SPREADSHEET
                        )
                        put1(
                            "eps",
        ...
        /**
         * Simply returns Ext or `null` if no Mimetype is found.
         */
        fun lookupExt(mimeType: String): String? {
            ...
            return extMapping!![mimeType.lowercase(Locale.getDefault())]
        }
         ...
         */
        fun getDefaultExt(mimeType: String): String? {
            var ext = lookupExt(mimeType)
            if (ext == null) {
                ext = "unknown"
            }
            return ext
