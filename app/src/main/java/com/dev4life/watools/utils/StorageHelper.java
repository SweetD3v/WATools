package com.dev4life.watools.utils;
...
import com.dev4life.watools.utils.ErrorCause;import com.dev4life.watools.utils.ProgressException;import com.orhanobut.hawk.Hawk;
...
public class StorageHelper {
    ...
    public static Uri getUriForFile(Context context, File file) {
        return FileProvider.getUriForFile(context, WAToolsApp.Companion.getInstance().getPackageName() + ".provider", file);
    }
